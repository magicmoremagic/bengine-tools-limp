...
LimpApp::LimpApp(int argc, char** argv) {
   ...
   try {
      ...
      proc
         ...
         (param ({ },{ "depfile" }, "PATH", "Outputs included scripts and templates to a dependency file.",
            [&](const S& str) {
         ...
         (flag({ },{ "test" }, "Ignores other options, outputs nothing, and returns status code 0.", test_))
